...
#define MIN_RESOLUTION_CURVATURE 1.e-13 #TODO? not !
...
public:
    ...
    void add_parameter(int iSurface, sParameter, bRefine=False); # auto min & max
    void add_parameter(int iSurface, sParameter, dMin, dMax)
    void set_merit_function(OptimizerMeritFunction eMeritFunction)

    virtual OptimizerResult optimize()=0

protected:
    void apply_parameter( ParameterSet& parameters)
